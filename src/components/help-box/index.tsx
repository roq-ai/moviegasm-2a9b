...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Content Editor'];
  const customerRoles: string[] = ['Guest User'];
  const tenantRoles: string[] = ['Site Owner', 'Content Editor', 'Movie Critic'];
  const addOns: string[] = [];
  const applicationName = `Moviegasm`;
  const tenantName = `Website`;
