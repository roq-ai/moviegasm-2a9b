...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiStar, FiGlobe } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['content-editor', 'site-owner', 'movie-critic'];
  ...
  const { data, error, isLoading } = useSWR<WebsiteInterface[]>(
    ...
    () => getWebsites({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
